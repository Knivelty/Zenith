...
export async function setupWorld(provider: DojoProvider) {
    ...
    function home() {
        ...
        const setCreatureProfile = async (props: { account: Account, p: models.CreatureProfile }) => {
            try {
                return await provider.execute(
                    props.account,
                    contract_name,
        ...
        const setStageProfile = async (props: { account: Account, p: models.StageProfile }) => {
            try {
                return await provider.execute(
                    props.account,
                    contract_name,
        ...
        const buyHero = async (props: { account: Account, altarSlot: Number, invSlot: Number }) => {
            try {
                return await provider.execute(
                    props.account,
                    contract_name,
        ...
        const commitPreparation = async (props: { account: Account, changes: models.array, result: models.RoundResult }) => {
            try {
                return await provider.execute(
                    props.account,
                    contract_name,
        ...
        return {
            dojoResource, initialize, setCreatureProfile, setStageProfile, spawn, refreshAltar, buyHero, buyExp, sellHero, commitPreparation, nextRound, startBattle, getCoin, exit
        };
    }
